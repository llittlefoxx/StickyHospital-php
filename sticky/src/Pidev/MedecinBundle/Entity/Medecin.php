...
class Medecin
{
     ...
     * Set idService
     *
     * @param \Pidev\MedecinBundle\Entity\Service $idService
     * @return Medecin
     */
    public function setIdService(\Pidev\MedecinBundle\Entity\Service $idService = null)
    {
    ...
    public function __toString() {
        return $this->nomMedecin." ".$this->prenomMedecin." (S)".$this->specialiteMedecin;
    }
