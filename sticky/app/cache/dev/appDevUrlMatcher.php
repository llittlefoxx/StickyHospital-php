...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/Backend')) {
            ...
            if ($pathinfo === '/Backend/hello') {
                return array (  '_controller' => 'Backend\\MedecinBundle\\Controller\\DefaultController::indexAction',  '_route' => 'backend_medecin_homepage',);
            }
        ...
        if (0 === strpos($pathinfo, '/Hopital')) {
            ...
            if ($pathinfo === '/Hopital/home') {
                return array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\DefaultController::indexAction',  '_route' => 'sticky_bit_hospital_homepage',);
            }

            if (0 === strpos($pathinfo, '/Hopital/envoyer')) {
                // envoyernewmsgMed
                if ($pathinfo === '/Hopital/envoyernewmsgtoMed') {
                    return array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\messageMedController::envoyernewmsgtoMedAction',  '_route' => 'envoyernewmsgMed',);
                }

                // envoyermsgmed
                if (0 === strpos($pathinfo, '/Hopital/envoyermsgmed') && preg_match('#^/Hopital/envoyermsgmed/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'envoyermsgmed')), array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\messageMedController::envoyermsgtoMedAction',));
                }
            ...
            if (0 === strpos($pathinfo, '/Hopital/home')) {
                ...
                // home
                if ($pathinfo === '/Hopital/home') {
                    return array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\messagemedController::afficherhomemedAction',  '_route' => 'home',);
                }
            ...
            // sticky_bit_hospital_affichage_ord
            if ($pathinfo === '/Hopital/affichageOrd') {
                return array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\OrdonnanceController::affichageAction',  '_route' => 'sticky_bit_hospital_affichage_ord',);
            }

            // sticky_bit_hospital_ligne_ord
            if (0 === strpos($pathinfo, '/Hopital/ligneOrd') && preg_match('#^/Hopital/ligneOrd/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'sticky_bit_hospital_ligne_ord')), array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\OrdonnanceController::ligneAction',));
            }

            if (0 === strpos($pathinfo, '/Hopital/P')) {
                // sticky_bit_hospital_pdf_ord
                if (0 === strpos($pathinfo, '/Hopital/PdfOrd') && preg_match('#^/Hopital/PdfOrd/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'sticky_bit_hospital_pdf_ord')), array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\OrdonnanceController::generatePdfOrdAction',));
                }

                // frontend_patient_homepage
                if (0 === strpos($pathinfo, '/Hopital/Profile') && preg_match('#^/Hopital/Profile/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'frontend_patient_homepage')), array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\ProfileController::indexAction',));
                }

            }

            // frontend_patient_affichedossiermedical
            if (0 === strpos($pathinfo, '/Hopital/affichageDossierMedical') && preg_match('#^/Hopital/affichageDossierMedical/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'frontend_patient_affichedossiermedical')), array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\ProfileController::afficherAction',));
            }

            // frontend_patient_printdossierMedical
            if (0 === strpos($pathinfo, '/Hopital/printDossierMedical') && preg_match('#^/Hopital/printDossierMedical/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'frontend_patient_printdossierMedical')), array (  '_controller' => 'StickyBit\\HospitalBundle\\Controller\\ProfileController::printAction',));
            }
        ...
        if (0 === strpos($pathinfo, '/Medecin')) {
            // pidev_medecin_homepage
            if (0 === strpos($pathinfo, '/Medecin/hello') && preg_match('#^/Medecin/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'pidev_medecin_homepage')), array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\DefaultController::indexAction',));
            }

            // rechPat
            if ($pathinfo === '/Medecin/searchPat') {
                return array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\PatientController::searchAction',  '_route' => 'rechPat',);
            }

            // rechPater
            if (0 === strpos($pathinfo, '/Medecin/msg') && preg_match('#^/Medecin/msg/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'rechPater')), array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\PatientController::indexAction',));
            }

            // contact
            if ($pathinfo === '/Medecin/contact') {
                return array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\PageController::contactAction',  '_route' => 'contact',);
            }

            if (0 === strpos($pathinfo, '/Medecin/rdv')) {
                // rdv
                if (rtrim($pathinfo, '/') === '/Medecin/rdv') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_rdv;
                    }
                    ...
                    return array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::indexAction',  '_route' => 'rdv',);
                }
                not_rdv:

                // rdv_create
                if ($pathinfo === '/Medecin/rdv/') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_rdv_create;
                    }

                    return array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::createAction',  '_route' => 'rdv_create',);
                }
                not_rdv_create:

                // rdv_new
                if ($pathinfo === '/Medecin/rdv/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_rdv_new;
                    }

                    return array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::newAction',  '_route' => 'rdv_new',);
                }
                not_rdv_new:

                // rdv_show
                if (preg_match('#^/Medecin/rdv/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_rdv_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'rdv_show')), array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::showAction',));
                }
                not_rdv_show:

                // rdv_edit
                if (preg_match('#^/Medecin/rdv/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_rdv_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'rdv_edit')), array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::editAction',));
                }
                not_rdv_edit:
                ...
                if (preg_match('#^/Medecin/rdv/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'rdv_update')), array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::updateAction',));
                }
                not_rdv_update:
                ...
                if (preg_match('#^/Medecin/rdv/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'rdv_delete')), array (  '_controller' => 'Pidev\\MedecinBundle\\Controller\\RdvController::deleteAction',));
                }
                not_rdv_delete:
