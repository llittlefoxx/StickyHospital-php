...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'testpi', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_b0d739021697f93311ef1a8af9819120');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b0d739021697f93311ef1a8af9819120');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_b0d739021697f93311ef1a8af9819120');

        $e = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\StickyBit\\HospitalBundle\\Resources\\config\\doctrine') => 'StickyBit\\HospitalBundle\\Entity', ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle\\Resources\\config\\doctrine') => 'FOS\\UserBundle\\Entity'));
        $e->setGlobalBasename('mapping');

        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\StickyBit\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Backend\\MedecinBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Pidev\\MedecinBundle\\Entity')));

        $g = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $g->addDriver($e, 'StickyBit\\HospitalBundle\\Entity');
        $g->addDriver($e, 'FOS\\UserBundle\\Entity');
        $g->addDriver($f, 'StickyBit\\UserBundle\\Entity');
        $g->addDriver($f, 'Backend\\MedecinBundle\\Entity');
        $g->addDriver($f, 'Pidev\\MedecinBundle\\Entity');

        $h = new \Doctrine\ORM\Configuration();
        $h->setEntityNamespaces(array('StickyBitHospitalBundle' => 'StickyBit\\HospitalBundle\\Entity', 'StickyBitUserBundle' => 'StickyBit\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'BackendMedecinBundle' => 'Backend\\MedecinBundle\\Entity', 'PidevMedecinBundle' => 'Pidev\\MedecinBundle\\Entity'));
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('StickyBit\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('StickyBit\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'StickyBit\\UserBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \StickyBit\HospitalBundle\Redirection\AfterLoginRedirection A StickyBit\HospitalBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \StickyBit\HospitalBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('/listservice');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('dali05005@gmail.com');
        $a->setPassword(247668);
        $a->setAuthMode('login');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'\\src\\Pidev\\MedecinBundle/Resources/translations\\messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\StickyBit\\HospitalBundle/Resources/views'), 'StickyBitHospital');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle\\FOS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Backend\\MedecinBundle/Resources/views'), 'BackendMedecin');
        $instance->addPath(($this->targetDirs[3].'\\src\\Pidev\\MedecinBundle/Resources/views'), 'PidevMedecin');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'StickyBitHospitalBundle' => 'StickyBit\\HospitalBundle\\StickyBitHospitalBundle',
                'StickyBitUserBundle' => 'StickyBit\\UserBundle\\StickyBitUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'BackendMedecinBundle' => 'Backend\\MedecinBundle\\BackendMedecinBundle',
                'PidevMedecinBundle' => 'Pidev\\MedecinBundle\\PidevMedecinBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'testpi',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'dali05005@gmail.com',
            'mailer_password' => 247668,
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'dali05005@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 247668,
            ...
            'fos_user.model.user.class' => 'StickyBit\\UserBundle\\Entity\\User',
