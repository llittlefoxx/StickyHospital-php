 ...
 */
class DossierAdministratif extends \StickyBit\HospitalBundle\Entity\DossierAdministratif implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function getIdDadmin()
    {
        if ($this->__isInitialized__ === false) {
            return (int) $this->_identifier["idDadmin"];
        }
        $this->__load();
    ...
    {
        return array('__isInitialized__', 'dateCreation', 'idDadmin', 'idDossierpatient');
    }
