...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sprintweb3', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\StickyBit\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Backend\\MedecinBundle\\Entity')));
        ...
        $h->setEntityNamespaces(array('StickyBitHospitalBundle' => 'StickyBit\\HospitalBundle\\Entity', 'StickyBitUserBundle' => 'StickyBit\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'BackendMedecinBundle' => 'Backend\\MedecinBundle\\Entity'));
